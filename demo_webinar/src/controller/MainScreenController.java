...
/**RUNTIME ERROR: NUll pointer exception (location was wrong, changed "addpart.fxml" to "../addpart.fxml"
 LOGICAL ERROR: also put wrong methods for the text input boxes in scene builder. I selected the 'whentextchanged' action rather
 than saving all of the inputs as variables when the save button was pressed.*/
...
public class MainScreenController implements Initializable {
    ...
    /** This searches for a part with Name or ID and populates the tableview with found parts. */
    ...
    /** This searches for a product with Name or ID entered. */
